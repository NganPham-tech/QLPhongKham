        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoUrl = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true, defaultValue: "/images/default-doctor.jpg"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Unit = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValue: "Viên"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoUrl = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true, defaultValue: "/images/default-staff.jpg")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false, defaultValue: "Scheduled"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagedByStaffId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inventories_Staffs_ManagedByStaffId",
                        column: x => x.ManagedByStaffId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_ManagedByStaffId",
                table: "Inventories",
